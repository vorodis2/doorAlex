...
export function ZDinMenuScene(par,sceneSB, fun) {  
    var self=this   
    this.type="ZDinMenuScene";
    this.fun=fun;
    this.par=par;
   ...
   // this.objectBase=this.par.objectBase;
    ...
    this.w=new DPanel(null, 0, 0);
    this.w.width=this.widthBig*2+this.otstup;
 
    this.cont=new DCont(this.w);
    this.cont.y=this.otstup
    this.content=new DCont(this.cont);
    this.cont.visible=false;


    this.panel=new DPanel(this.w,this.otstup,this.otstup);
    this.panel.width=150;

    this.sceneSB=sceneSB//new SceneSB(sceneSB);
    


    this.panel1=new DPanel(this.w,this.panel.width+this.otstup*2,this.otstup); 
 ...
 /*  let oo=mhbd.getKeyId("info", 177, function(e){
